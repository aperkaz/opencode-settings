---
name: understand
description: Contruct an in depth summary of project or module for speeding up understanding. Use when user wants understand the details of a project or module.
---
